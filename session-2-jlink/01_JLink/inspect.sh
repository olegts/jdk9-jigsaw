...
/Users/oleg/dev/jdk-9.jdk/Contents/Home/bin/jimage info executable/lib/modules


echo
echo "${info} *** A summary of all the modules it contains *** ${normal}"
/Users/oleg/dev/jdk-9.jdk/Contents/Home/bin/jimage list executable/lib/modules | grep "Module:"
